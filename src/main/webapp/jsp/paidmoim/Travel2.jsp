...
<body>
	<form action="TravelC2" style="margin-left: 1200px; margin-top: 50px;">
		...
		<input name="interest" type="hidden" value="여행">
	    <button id="searchBtn">검색</button>
	</form> 
	
	<div id="moimBack">
		<c:forEach var="m" items="${moims }"> 
		<c:set var="interest" value="여행" /> 
		<c:if test="${m.interest eq '여행'}">
