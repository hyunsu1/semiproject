...
<body>
	<form action="MusicC2" style="margin-left: 1200px; margin-top: 50px;">
		...
		<input name="interest" type="hidden" value="음악">
	    <button id="searchBtn">검색</button>
	</form> 
	
	<div id="moimBack">
		<c:forEach var="m" items="${moims }"> 
		<c:set var="interest" value="음악" /> 
		<c:if test="${m.interest eq '음악'}">
