...
@WebServlet("/PB_RegC")
public class PB_RegC extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		AccountDAO.loginCheck(request);
		
		request.setAttribute("contentPage", "mg_pboard/PhotoBoardReg.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		AccountDAO.loginCheck(request);
//		PhotoBoardDAO.insPhotoBoard(request);
//		PhotoBoardDAO.getallPhotoBoard(request);
		PhotoBoardDAO.getPdao().insPhotoBoard(request);
